...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1600_RPDOMappingParameter = {
        ...
        .applicationObject2 = 0x21010008,
        .applicationObject3 = 0x21020008,
        .applicationObject4 = 0x21030008,
        .applicationObject5 = 0x21040008,
        .applicationObject6 = 0x21050008,
        .applicationObject7 = 0x21060008,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_co_power_on_counter = 0x00000000,
    .x2001_co_cycle_status = 0x00,
    .x2002_co_actual_cycle_time = 0x0000,
    .x2003_co_door_status = 0x00,
    .x2100_co_cycle_recipe = 0x00,
    .x2101_co_general_command = 0x00,
    .x2102_co_timing_prewash = 0x00,
    .x2103_co_timing_wash = 0x00,
    .x2104_co_timing_rinse = 0x00,
    .x2105_co_timing_spin = 0x00,
    .x2106_co_testing_value = 0x00,
...
typedef struct {
    ...
    OD_obj_var_t o_2000_co_power_on_counter;
    OD_obj_var_t o_2001_co_cycle_status;
    OD_obj_var_t o_2002_co_actual_cycle_time;
    OD_obj_var_t o_2003_co_door_status;
    OD_obj_var_t o_2100_co_cycle_recipe;
    OD_obj_var_t o_2101_co_general_command;
    OD_obj_var_t o_2102_co_timing_prewash;
    OD_obj_var_t o_2103_co_timing_wash;
    OD_obj_var_t o_2104_co_timing_rinse;
    OD_obj_var_t o_2105_co_timing_spin;
    OD_obj_var_t o_2106_co_testing_value;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_co_power_on_counter = {
        .dataOrig = &OD_RAM.x2000_co_power_on_counter,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_2001_co_cycle_status = {
        .dataOrig = &OD_RAM.x2001_co_cycle_status,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2002_co_actual_cycle_time = {
        .dataOrig = &OD_RAM.x2002_co_actual_cycle_time,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2003_co_door_status = {
        .dataOrig = &OD_RAM.x2003_co_door_status,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2100_co_cycle_recipe = {
        .dataOrig = &OD_RAM.x2100_co_cycle_recipe,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2101_co_general_command = {
        .dataOrig = &OD_RAM.x2101_co_general_command,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2102_co_timing_prewash = {
        .dataOrig = &OD_RAM.x2102_co_timing_prewash,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2103_co_timing_wash = {
        .dataOrig = &OD_RAM.x2103_co_timing_wash,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2104_co_timing_rinse = {
        .dataOrig = &OD_RAM.x2104_co_timing_rinse,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2105_co_timing_spin = {
        .dataOrig = &OD_RAM.x2105_co_timing_spin,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2106_co_testing_value = {
        .dataOrig = &OD_RAM.x2106_co_testing_value,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x01, ODT_VAR, &ODObjs.o_2000_co_power_on_counter, NULL},
    {0x2001, 0x01, ODT_VAR, &ODObjs.o_2001_co_cycle_status, NULL},
    {0x2002, 0x01, ODT_VAR, &ODObjs.o_2002_co_actual_cycle_time, NULL},
    {0x2003, 0x01, ODT_VAR, &ODObjs.o_2003_co_door_status, NULL},
    {0x2100, 0x01, ODT_VAR, &ODObjs.o_2100_co_cycle_recipe, NULL},
    {0x2101, 0x01, ODT_VAR, &ODObjs.o_2101_co_general_command, NULL},
    {0x2102, 0x01, ODT_VAR, &ODObjs.o_2102_co_timing_prewash, NULL},
    {0x2103, 0x01, ODT_VAR, &ODObjs.o_2103_co_timing_wash, NULL},
    {0x2104, 0x01, ODT_VAR, &ODObjs.o_2104_co_timing_rinse, NULL},
    {0x2105, 0x01, ODT_VAR, &ODObjs.o_2105_co_timing_spin, NULL},
    {0x2106, 0x01, ODT_VAR, &ODObjs.o_2106_co_testing_value, NULL},
